  ...
  "inline-flex items-center justify-center whitespace-nowrap rounded-lg text-sm font-medium ring-offset-background transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        ...
        outline:
          "border border-white/10 bg-glass hover:bg-glass/80 hover:border-teal-500/50 hover:text-teal-400",
        secondary:
          "bg-secondary/80 text-secondary-foreground hover:bg-secondary/60 backdrop-blur-sm",
        ghost: "hover:bg-glass hover:text-teal-400",
        link: "text-primary underline-offset-4 hover:underline",
        glass: "glass-btn text-foreground hover:text-teal-400 hover:scale-[1.02] active:scale-[0.98]",
      },
      size: {
